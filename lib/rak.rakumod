...
use Git::Files:ver<0.0.9+>:auth<zef:lizmat>;    # git-files
use hyperize:ver<0.0.4+>:auth<zef:lizmat>;      # hyperize racify
use paths:ver<10.2+>:auth<zef:lizmat> 'paths';  # paths
use path-utils:ver<0.0.24+>:auth<zef:lizmat>;   # path-*
use Trap:ver<0.0.5+>:auth<zef:lizmat>;          # Trap
